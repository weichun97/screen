...
*/
@Data
@ApiModel(value = "${packageName}.<#if module!=null && module?length gt 0>${module?trim}.</#if>entity.param.${tableInfo.tableNameCamelCase?lower_case}.${tableInfo.tableNameCamelCase}SaveParam")
public class ${tableInfo.tableNameCamelCase}SaveParam implements Serializable{
